...
LakeSoulFragment::ScanBatchesAsync(
...
std::string LakeSoulFragment::type_name() const { return "lakesoul"; }
...
void LakeSoulFragment::CreateDataReader() {
  data_reader_ = std::make_shared<lakesoul::LakeSoulDataReader>(
      schema_, file_urls_, primary_keys_, partition_info_);
...
void LakeSoulFragment::SetObjectStoreConfigs(
